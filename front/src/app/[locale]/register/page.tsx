...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row text-on-surface bg-background font-body-md antialiased selection:bg-primary/20 selection:text-primary">
      {/* Form Section */}
      <div className="flex-1 flex items-center justify-center p-6 order-1">
          ...
          <div className="bg-surface rounded-xl border border-outline p-8 w-full flex flex-col gap-6 shadow-[0_8px_32px_rgba(0,0,0,0.5)]">
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                ...
                {t("signup_google")}
                <span className="text-xs text-on-surface-variant/60 ml-1">(coming soon)</span>
              </button>
      ...
      <div className="flex-1 relative overflow-hidden order-2 min-h-[300px] lg:min-h-screen">
        ...
        >
          <source src="https://storage.googleapis.com/linguistai-assets/scenes/scene1.webm" type="video/webm" />
          <source src="https://storage.googleapis.com/linguistai-assets/scenes/scene1.mp4" type="video/mp4" />
        </video>
      </div>
    </div>
  );
