    ...
    return (
      <div className="animate-fade-in space-y-lg pb-24">
        <header className="flex items-center gap-sm">
          <Link
            href="/progress"
            className="flex items-center text-on-surface-variant hover:text-on-surface transition-colors p-1 rounded-md"
          >
        ...
        <div className="flex flex-col items-center justify-center py-16 gap-3 text-center">
          ...
          <p className="text-xs text-on-surface-variant ">
            Your first weekly AI coaching report will appear here after you
            complete a week of learning.
          </p>
        </div>
      </div>
    );
    ...
    <div className="animate-fade-in space-y-lg pb-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-md">
        <div className="md:col-span-1 flex flex-col gap-sm">
          <h3 className="font-label-md text-xs font-bold text-on-surface-variant uppercase tracking-wider mb-xs px-2">
            History
          </h3>
        ...
        {report && (
          <div className="md:col-span-2 bg-surface rounded-xl p-6 border border-outline shadow-lg flex flex-col gap-6">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-sm">
                  {persistentAreas.map((a) => (
                    <div
                      key={a.label}
                      className="bg-surface-bright/40 p-3 rounded-lg border border-outline flex items-center"
                    >
            ...
            <div className="bg-surface-bright/40 p-5 rounded-lg border border-outline flex flex-col gap-3">
              <h4 className="font-label-md text-xs font-bold text-on-surface uppercase tracking-wider">
            ...
            <div className="flex justify-end pt-2">
              <Link
                href="/missions"
                className="bg-primary hover:bg-primary/95 text-white font-medium py-2.5 px-5 rounded-lg active:scale-[0.96] transition-all border border-[#8B7CFF]/30 text-sm shadow-md"
              >
