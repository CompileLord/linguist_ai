      ...
      <div className="animate-fade-in max-w-[800px] mx-auto space-y-lg pb-24">
        ...
        <div className="flex flex-col items-center justify-center py-16 gap-3 text-center">
          ...
          <p className="text-xs text-on-surface-variant max-w-xs">
            Complete the listening exam to see your results here.
          </p>
          <Link href={`/exams/listening/${examId}`} className="mt-2 bg-primary text-white text-sm font-semibold px-6 py-2.5 rounded-xl hover:bg-primary/95 transition-colors">
            Take Exam
          </Link>
        </div>
      </div>
