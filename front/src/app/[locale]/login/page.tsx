...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-sm md:p-md text-on-surface bg-background font-body-sm text-body-sm antialiased selection:bg-primary/20 selection:text-primary">
      <main className="w-full max-w-[420px] mx-auto flex flex-col gap-sm animate-fade-in">
        {/* Card Container */}
