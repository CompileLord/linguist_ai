        ...
        <main className="w-full max-w-[420px] flex flex-col gap-sm animate-fade-in">
          ...
          <div className="bg-surface rounded-xl border border-outline p-8 w-full flex flex-col gap-6 shadow-[0_8px_32px_rgba(0,0,0,0.5)]">
            ...
            <button
              ...
              disabled
              title="Coming soon"
              className="w-full bg-surface-raised border border-outline text-on-surface/40 font-medium py-2.5 px-4 rounded-lg cursor-not-allowed flex items-center justify-center gap-2 focus:outline-none opacity-50"
            >
