...
export function DiagnosticTestStep({ onComplete, onSkip }: Props) {
  ...
  return (
    <div className="flex-grow flex flex-col items-center justify-start pt-lg pb-xl px-md sm:px-lg max-w-[800px] w-full">
      {/* Progress Indicator */}
      ...
      {/* Answer Options */}
      <div className="w-full max-w-[480px] flex flex-col gap-sm">
      ...
      {isChecked && (
        <div
          className={`w-full max-w-[480px] mt-md p-md rounded-[10px] border text-left transition-all duration-300
            ${isCorrect 
      ...
      <div className="mt-lg w-full max-w-[480px] flex flex-col gap-sm items-center">
        {!isChecked ? (
          <button
            onClick={handleCheck}
